...
import TextI18NSidebarPanel from './input-panels/TextI18NSidebarPanel';
...
export default function ConfigurationPanel() {
  ...
  switch (type) {
    ...
    case 'TextI18N':
      return <TextI18NSidebarPanel key={selectedBlockId} data={data} setData={(data) => setBlock({ type, data })} />;
    default:
